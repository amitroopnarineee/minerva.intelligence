  ...
  return (
    <div className="mn-shell">
      <PageHeader
        ...
        title="Prospecting Segments"
        subtitle="Create and manage your prospect audiences for targeting."
        actions={
      ...
      <div className="mn-page flex-1 px-6 pb-6">
        {/* Search + Filter bar */}
        <div className="mn-prospect-toolbar mb-4 flex items-center gap-3">
        ...
        {/* Table header */}
        <div className="mn-prospect-table rounded-xl border border-border">
