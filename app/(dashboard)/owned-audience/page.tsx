...
export default function OwnedAudiencePage() {
  return (
    <>
      <PageHeader breadcrumb="Owned Audience" title="Owned Audiences" subtitle="Manage audiences built from your connected first-party data."
        actions={<button className="flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground"><Plus className="h-4 w-4" /> Create Audience</button>}
      />
            ...
            <FadeIn>
              <div className="mb-4 flex items-center gap-3">
                <div className="flex flex-1 items-center gap-2 rounded-md border border-border px-3 py-2">
                  ...
                  <input type="text" placeholder="Search audiences..." className="flex-1 bg-transparent text-sm outline-none placeholder:text-muted-foreground" readOnly />
                </div>
